...
export const Produit = () => {
  return (
    <section className=''>
        ...
        <h3 className='mx-6 mt-6 md:mx-16 lg:mx-28 text-xl font-bold text-[#1C4179]'>Equipements et fournitures industrielles :</h3>
        ...
        <div className='text-xl md:text-2xl text-center font-bold text-[#1C4179] m-6 md:m-12'>
        ...
        <div className='bg-[#1C4179] text-white max-w-[260px] sm:max-w-[500px] lg:max-w-[800px] m-auto my-16 md:mt-32 px-6 py-4 md:px-12 md:py-6  shadow-[-12px_-12px_#F49F1E] md:shadow-[-20px_-20px_#F49F1E] lg:shadow-[-40px_-40px_#F49F1E]'>
        ...
        <div className='my-12'>
            <h3 className=' mx-6 mt-6 md:mx-16 lg:mx-28 text-xl font-bold text-[#1C4179]'>Gestion de projets et commandes spéciales</h3>
            ...
            <ul className='mx-6 md:mx-16 lg:mx-28 text-justify list-disc list-inside px-2 md:px-8'>
