...
export const Produit = () => {
  return (
    <section id='produit' className='max-w-[2560px] m-auto'>
        ...
        <div className='bg-[#1C4179] text-white max-w-5/6 sm:max-w-[500px] lg:max-w-[800px] xl:max-w-[900px] m-auto md:mt-32 px-6 py-4 md:px-12 md:py-6  shadow-[-12px_-12px_#F49F1E] md:shadow-[-20px_-20px_#F49F1E] lg:shadow-[-40px_-40px_#F49F1E]'>
        ...
        <img className='h-[100vh] object-cover' loading="lazy" src="./img/produit_bas/26.png " alt="Industry inside" />
