...
export const Savoir = () => {
  return (
    <div>
        <h2 id='synergie' className='bg-[#1C4179] text-[#F49F1E] text-2xl xl:text-3xl font-black text-center uppercase w-full p-8 lg:p-12 2xl:p-18'>SYNERGIE DES SAVOIR-FAIRE</h2>
        
        <h3 className='mx-6 mt-6 md:mt-12 md:mx-16 lg:mx-28 2xl:mx-56 text-xl xl:text-2xl font-bold text-[#1C4179]'>DMC CONSULTING :</h3>
        <p className='mx-6 md:mx-16 lg:mx-28 2xl:mx-56 text-justify xl:text-lg'>Fruit d’une vision commune et ambitieuse : celle d’unir des expertises complémentaires pour répondre aux besoins variés et complexes des industriels, en leur proposant des solutions fiables, innovantes et sur mesure. Fondée par l’association de trois entités aux parcours solides et aux ressources stratégiques, DMC CONSULTING se distingue par sa polyvalence, son agilité et sa capacité à opérer dans des environnements diversifiés.</p>
        
        <div className='m-6 md:mx-16 lg:mx-56 2xl:mx-80  flex flex-col gap-8 xl:text-lg'>
            <div className='grid md:grid-cols-3 gap-4 items-center'>
                <img loading="lazy" className='w-52 m-auto' src="./img/savoir_faire/image 2.png" alt="STC Consulting sourcing technical commercial" />
            ...
            <div className='grid md:grid-cols-3 gap-4 items-center'>
                <img loading="lazy" className='w-52 m-auto' src="./img/savoir_faire/Frame 128.png " alt="CVR Group conopee services" />
                <p className='md:col-span-2 text-justify'>
            ...
            <div className='grid md:grid-cols-3 gap-4 items-center'>
                <img loading="lazy" className='w-52 m-auto' src="./img/savoir_faire/DLBH (2) 1.png " alt="DLBH logo" />
                <p className='md:col-span-2 text-justify'>
        ...
        <h2 id='engagements' className='bg-[#1C4179] text-[#F49F1E] text-2xl xl:text-3xl font-black text-center uppercase w-full p-8 lg:p-12 2xl:p-18'>NOS ENGAGEMENTS</h2>
        <div style={{
        ...
        className="w-full p-8">
            <img loading="lazy" className='md:h-[86vh] w-full m-auto my-2 object-contain ' src="./img/savoir_faire/Group 11.png" alt="Nos Engagement Qualite, fiabilite, delais, expertise technique" />
        </div>
    </div>
  )
}
