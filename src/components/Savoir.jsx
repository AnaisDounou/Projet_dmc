...
export const Savoir = () => {
  return (
    <div>
        ...
        <img loading="lazy" src="./img/savoir_faire/2-2 1.png " alt="faire une bonne affaire" />
        ...
        className="w-full p-8">
            <img loading="lazy" className='md:h-[96vh] w-full m-auto my-2 object-contain ' src="./img/savoir_faire/Group 11.png" alt="Nos Engagement Qualite, fiabilite, delais, expertise technique" />
        </div>
    </div>
  )
}
