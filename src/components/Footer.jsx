...
export const Footer = () => {
  return (
    <footer className='bg-[#1C4179] p-6 lg:px-28 lg:py-8 grid grid-cols-1 lg:grid-cols-3 justify-center gap-6 lg:gap-16'>
        <div>
            <img src="./img/logo_dmc.png" alt="DMC logo" className='p-6'/>
            <p className='text-[15px] text-center text-white'>“Votre besoin. Notre solution. Votre réussite”</p>
        </div>
        <div className='col-span-2'>

        <div className='grid grid-cols-2 lg:grid-cols-3 text-white '>
            <div>
